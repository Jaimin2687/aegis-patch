...
export default function StatusPanel({ currentStage, isError = false }) {
  ...
  return (
    <div className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 md:p-8 rounded-2xl shadow-sm">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center relative z-0">
        ...
        <div className="hidden md:block absolute top-5 left-5 right-5 h-[2px] bg-gray-100 dark:bg-gray-800 -z-10">
          <div 
        ...
        <div className="block md:hidden absolute top-5 bottom-[44px] left-5 w-[2px] bg-gray-100 dark:bg-gray-800 -z-10">
           <div 
            ...
            <div key={stage.id} className="flex md:flex-col items-center gap-4 md:gap-3 mb-6 md:mb-0 relative z-10 w-full md:w-auto">
              ...
              <div className="flex flex-col md:items-center">
                <span className={cn(
                  ...
                  isCompleted ? "text-gray-900 dark:text-gray-100" : isActive ? (isErrorNode ? "text-red-600" : "text-blue-600") : "text-gray-400"
                )}>
                  {stage.label}
                </span>
              </div>
