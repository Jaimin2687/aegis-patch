...
export default function VulnCard({ vuln }) {
  ...
  }[severity] || { variant: 'default', color: 'text-gray-500 dark:text-gray-400', bg: 'bg-gray-50 dark:bg-gray-950', border: 'border-gray-200 dark:border-gray-800', badgeBg: 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 border-gray-200 dark:border-gray-800', bar: 'bg-gray-400' };
  ...
  return (
    <>
      ...
      >
        <SpotlightCard className="h-full p-5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:border-gray-700 transition-all duration-300 rounded-xl flex flex-col gap-4 relative overflow-hidden">
          <div className="flex justify-between items-start gap-2 relative z-10">
            <div>
              <h4 className="font-bold text-lg text-gray-900 dark:text-gray-100 tracking-tight group-hover:text-blue-600 transition-colors flex items-center gap-2">
                {cveId}
              </h4>
              <p className="text-xs text-gray-500 dark:text-gray-400 font-mono mt-0.5 line-clamp-1">{title}</p>
            </div>
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 line-clamp-2 relative z-10 prose prose-sm prose-gray max-w-none">
          ...
          <div className="mt-auto pt-2 space-y-3 relative z-10">
            <div className="bg-gray-50 dark:bg-gray-950 p-3 rounded-lg border border-gray-200 dark:border-gray-800">
              <div className="text-xs font-mono text-gray-500 dark:text-gray-400 mb-1 flex justify-between items-center">
        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-y-auto">
            ...
            <motion.div
              ...
              className="relative w-full max-w-3xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-xl overflow-hidden z-10 my-8 text-gray-900 dark:text-gray-100"
            >
              ...
              <div className="p-6 sm:p-8 space-y-6 max-h-[85vh] overflow-y-auto">
                <div className="flex justify-between items-start gap-4 pb-4 border-b border-gray-100 dark:border-gray-800">
                  <div className="space-y-1">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight pt-1">
                      {title}
                    </h2>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-4 rounded-xl space-y-2">
                    <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">CVSS v3 Score</div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-4 rounded-xl space-y-1">
                    <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Affected Package</div>
                    <div className="font-mono text-base font-bold text-gray-900 dark:text-gray-100 truncate" title={packageName}>
                      {packageName}
                    </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-4 rounded-xl space-y-1">
                    <div className="text-xs text-gray-500 dark:text-gray-400 font-medium">Version Upgrade</div>
                ...
                <div className="space-y-3 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-5 rounded-xl">
                  ...
                  {ghsaId && (
                    <div className="pt-2 flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                      <span className="font-medium text-gray-600 dark:text-gray-400">Database Reference:</span>
                      <a 
                        href={advisoryUrl} 
                        target="_blank" 
                ...
                <div className="space-y-4 bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-800 p-5 rounded-xl">
                  <h3 className="text-base font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                    <svg className="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-3.5 rounded-lg space-y-1">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        Pins <code className="text-gray-800 dark:text-gray-200 font-mono">{packageName}</code> lockfile entry from version <span className="text-red-600">{installedVersion}</span> to secure release <span className="text-emerald-600">{targetVersion}</span>.
                      </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-3.5 rounded-lg space-y-1">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        Runs native <code className="text-gray-800 dark:text-gray-200 font-mono">npm test</code> inside isolated workspace to guarantee zero functional regressions.
                      </p>
                    </div>
                    ...
                    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-3.5 rounded-lg space-y-1">
                      ...
                      <p className="text-xs text-gray-600 dark:text-gray-400">
                        Creates branch <code className="text-gray-800 dark:text-gray-200 font-mono">aegis-patch/fix-...</code> and opens a complete Pull Request with fix notes.
                      </p>
                    </div>
                  </div>

                  <div className="pt-2">
                    <div className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1.5">Direct CLI Upgrade Command:</div>
                ...
                <div className="pt-2 flex items-center justify-between gap-4 border-t border-gray-100 dark:border-gray-800">
                  <a
                    href={advisoryUrl}
                    target="_blank"
                    rel="noopener noreferrer"
