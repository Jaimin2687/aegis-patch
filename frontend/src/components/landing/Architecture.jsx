...
const Node = ({ icon, label, className = "", isGlowing = false }) => (
  <div className={`relative flex items-center gap-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl px-5 py-4 shadow-sm z-10 w-full sm:w-auto min-w-[200px] ${className}`}>
...
export default function Architecture() {
  ...
  return (
    <section id="architecture" className="py-24 bg-gray-50 dark:bg-gray-950 dark:bg-gray-950 relative border-t border-gray-200 dark:border-gray-800 dark:border-gray-800 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="relative bg-white dark:bg-gray-900 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 dark:border-gray-800 rounded-3xl p-8 md:p-12 shadow-sm overflow-x-auto">
            ...
            <div className="min-w-[800px] flex flex-col items-center gap-6 py-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <Node 
                  ...
                  className="bg-gray-100 dark:bg-gray-800 dark:bg-gray-800"
                />
              </div>
