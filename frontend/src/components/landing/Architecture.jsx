...
export default function Architecture() {
  ...
  return (
    <section id="architecture" className="py-24 bg-gray-50 dark:bg-gray-950 relative border-t border-gray-200 dark:border-gray-800 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          <div className="relative bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 md:p-12 shadow-sm overflow-x-auto">
