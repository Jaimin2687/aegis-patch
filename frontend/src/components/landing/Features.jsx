...
export default function Features() {
  return (
    <section id="features" className="py-24 bg-gray-50 dark:bg-gray-950 relative border-t border-gray-200 dark:border-gray-800">
        ...
        >
          {features.map((feature, idx) => (
            <motion.div key={idx} variants={cardVariants}>
              <SpotlightCard className="h-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 p-6 rounded-2xl flex flex-col shadow-sm">
                <div className="w-12 h-12 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-700 dark:text-gray-300 mb-4 border border-gray-200 dark:border-gray-800">
                  {feature.icon}
                </div>
