      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500/20 to-indigo-500/20 border border-white/10 flex items-center justify-center text-cyan-400 shadow-[0_0_15px_rgba(0,0,0,0.5)] z-10">
                {step.icon}
              </div>
              <div>
