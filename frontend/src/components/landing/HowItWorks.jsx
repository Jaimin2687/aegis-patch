...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-24 bg-white relative border-t border-gray-200">
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        >
          ...
          <div className="hidden md:block absolute top-6 left-6 right-6 h-0.5 bg-gray-200"></div>
          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-white border border-gray-300 flex items-center justify-center text-gray-700 shadow-sm z-10">
                {step.icon}
              </div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2 flex items-center gap-2 md:justify-center">
